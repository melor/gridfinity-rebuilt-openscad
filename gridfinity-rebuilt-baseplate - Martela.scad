...
distancey = 328; 
// balance fill area on one side more?
x_offset = 10;
y_offset = 0;
...
// baseplate styles
style_plate = 0; // [0: thin, 1:weighted, 2:skeletonized, 3: screw together]
...
color("tomato") 
gridfinityBaseplate(gridx, gridy, length, distancex, distancey, style_plate, enable_magnet, style_hole, x_offset, y_offset);


// ===== CONSTRUCTION ===== //

module gridfinityBaseplate(gridx, gridy, length, dix, diy, sp, sm, sh, x_offset, y_offset) {
